...
import { toggleSignup, redirectLogin } from '../../redux/modals/modalSlice'
import Logo from '../../assets/images/Mesh_Red.png'
import SocialButtons from '../buttons/SocialButtons'
import { signupFields } from '../../assets/data/static/signupFields'
...
const SignupModal: React.FC = (): JSX.Element => {
    const open = useSelector((state: RootState) => state.modals.signupModal)
                ...
                <Grid container>
                    ...
                    <Grid item lg={8} md={8} sm={8} xs={12}>
                        <div className="h-full w-full bg-modalDark">
                            <div className="w-full h-full bg-dimWhite rounded-[36px] ">
                                <div className="px-10">
                                    <LanguageSelect />
                                </div>
