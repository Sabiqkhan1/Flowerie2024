...
const Amenities: React.FC<TabProps> = ({ nextStep, prevStep }): JSX.Element => {
    ...
    const [selectedAmenities, setSelectedAmenities] = useState<Array<number>>(
        amenities_from_redux?.map(Number) || []
    )
    ...
    console.log('Selected Amenity ==> ', selectedAmenities)
        ...
        >
            <div className="w-full h-full flex items-center justify-center">
                <div className="w-full h-[calc(100vh-190px)] overflow-auto sm:h-full px-2">
                    <div className="flex flex-wrap justify-around  sm:mt-12 xs:mt-10">
