...
const Gallery: React.FC<TabProps> = ({ nextStep, prevStep }): JSX.Element => {
    ...
    return (
        <Template
            ...
            back={back}
            cover={cover}
            description="Let’s add some photos of your decor and lighting"
        >
                        ...
                        <>
                            ...
                            >
                                <div className="flex flex-col items-center">
                                    ...
                                    />
                                    <p className="font-medium text-lg sm:text-center sm:text-lg">
                                ...
                                <label
                                    ...
                                    className="font-semibold text-lg underline underline-offset-1 cursor-pointer sm:text-sm"
                                >
